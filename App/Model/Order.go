...
type Order struct {
	...
	OrderInvoice              OrderInvoice `gorm:"references:OrderNumber;foreignKey:OrderNumber"`
	ShopDetail                ShopDetail   `gorm:"references:ShopId;foreignKey:ShopId"`
	OrderItem                 []OrderItem  `gorm:"foreignKey:OrderNumber;references:OrderNumber;"`
}
